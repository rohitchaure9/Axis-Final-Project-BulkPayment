...
public class PaymentTemplate {
	...
	int beneficiaryPinCode;
	String beneficiaryEmail1;
	String beneficiaryEmail2;
	long mobileNumber;
	String addInfo1;
	String addInfo2;
	String addInfo3;
	...
	public PaymentTemplate(long debitAccountNumber, double transactionAmount, String transactionCurrency,
			...
			long mobileNumber, String addInfo1, String addInfo2, String addInfo3,
			String addInfo4, String addInfo5, String addInfo6) {
		super();
